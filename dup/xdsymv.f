...
*DECK XDSYMV
      SUBROUTINE XDSYMV (UPLO, N, ALPHA, A, LDA, X, INCX, BETA, Y, INCY)
C***BEGIN PROLOGUE  XDSYMV
C***PURPOSE  Perform the matrix-vector operation.
C***LIBRARY   SLATEC (BLAS)
C***CATEGORY  D1B4
C***TYPE      DOUBLE PRECISION (SSYMV-S, XDSYMV-D, CSYMV-C)
...
C***DESCRIPTION
C
C  XDSYMV  performs the matrix-vector  operation
C
...
C     .. Intrinsic Functions ..
      INTRINSIC          MAX
C***FIRST EXECUTABLE STATEMENT  XDSYMV
C
