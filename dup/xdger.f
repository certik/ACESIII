...
*DECK XDGER
      SUBROUTINE XDGER (M, N, ALPHA, X, INCX, Y, INCY, A, LDA)
C***BEGIN PROLOGUE  XDGER
C***PURPOSE  Perform the rank 1 operation.
C***LIBRARY   SLATEC (BLAS)
C***CATEGORY  D1B4
C***TYPE      DOUBLE PRECISION (XDGER-D)
...
C***DESCRIPTION
C
C  XDGER   performs the rank 1 operation
C
C     A := alpha*x*y' + A,
C
...
C     .. Intrinsic Functions ..
      INTRINSIC          MAX
C***FIRST EXECUTABLE STATEMENT  XDGER
C
