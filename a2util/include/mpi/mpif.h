#if defined(_AIX) && defined(F_64BIT)
#error "IBM's mpif.h explicitly declares integers as INTEGER*4"
#error "Copy /usr/lpp/ppe.poe/include/thread64/mpif.h to the top-level include"
#error "and replace every occurance of INTEGER*4 with just INTEGER"
#endif
!
!
