     ...
     &   NPOP,NFCT,NANGMOM,NMOMFCT,NMOMAO,IMEMB,ALPHA,PCOEFF,NAOATM,
     &   SALPHA,SPCOEF,ISHL,MAXANG)
C     
...
c addition
                     DO 46 I1=1,NAO
c                        ALPHA(I+IOFF+IATMOFF+(I1-1)*NP1)=SALPHA(I)
                        DO 57 J=1,NP2
                           PCOEFF(JATMOFF+(JOFF+JSHOFF2)*ITFCT+I+IOFF+
     $                        IATMOFF+(I1-1)*NP1)=SPCOEF((J-1)*NP1+I)
                           JSHOFF2=JSHOFF2+1
57                     CONTINUE
46                  CONTINUE
