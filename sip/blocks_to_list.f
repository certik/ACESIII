...
C  in the file COPYRIGHT.
      subroutine blocks_to_list(array_table, narray_table, 
     *                      index_table,
...
c--------------------------------------------------------------------------
     ...
     *        nblock_map_table
      ...
      if (first_blocks_to_list) then
         first_blocks_to_list = .false.
         narray_list          = 0
      endif

      narray_list = narray_list + 1
      if (narray_list .gt. max_array_list) then
         print *,'Error: BLOCKS_TO_LIST arrays exceeds maximum of ',
     *       max_array_list
         call abort_job()
      endif
