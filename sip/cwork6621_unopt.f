...
C  in the file COPYRIGHT.
       subroutine cwork6621_unopt(y, na1,na2,nb1,nb2,nc1,nc2,nd1,nd2,
     *                         ne1,ne2,nf1,nf2,
...
c--------------------------------------------------------------------------
     ...
     *                    nk1:nk2,nl1:nl2)
      ...
      integer ia,ib,ic,id,ie,if, ix_con1, ix(6), ix2(2), iy
...
c---------------------------------------------------------------------------
      ...
      do i = 1, 6
         if (indx1(i) .eq. inda) then 
            ...
            print *,'Error: Invalid index for x1 in cwork6621'
...
c---------------------------------------------------------------------------
      ...
      do i = 1, 2
         if (indx2(i) .eq. inda) then 
            ...
            print *,'Error: Invalid index for x2 in cwork6621'
