...
C  in the file COPYRIGHT.
       subroutine cwork4643_unopt(y, na1,na2,nb1,nb2,
     *                         nc1,nc2,nd1,nd2,
     *                         a1,a2,b1,b2,
     *                         c1, c2, d1, d2,
     *                         inda, indb, indc, indd,
...
c
      integer ia,ib,ic,id,ie,if, ix_con1, ix_con2, ix_con3,   
     *        ix(6), ix2(4), iy
      integer ia2, ib2, ic2, id2, ie2, if2 
      integer ix2_con1, ix2_con2, ix2_con3  
...
c---------------------------------------------------------------------------
      ...
      do i = 1, 6
         if (indx1(i)      .eq. inda) then 
            ...
            print *,'Error: Invalid index for x1 in cwork4643'
...
c---------------------------------------------------------------------------
      ...
      do i = 1, 4
         if (indx2(i)      .eq. inda) then 
            ...
            print *,'Error: Invalid index for x2 in cwork4643'
...
c     print *,'cwork4643: Unoptimized version lineno ',current_line
      do a = a1, a2
         if (ia  .ne. 0) ix(ia)   = a
