...
C  in the file COPYRIGHT.
      subroutine tester_MRT1(a1,a2,b1,b2,c1,c2,d1,d2,
     *                 der_flags,
     *                 scr,maxblk,
...
c----------------------------------------------------------------------------
c   Set the flags array for the FIRST derivative --> NONE!.
c----------------------------------------------------------------------------
...
c    *                der_flags(1), der_flags(2), der_flags(3),
c    *                der_flags(4), der_flags(5), der_flags(6),
c    *                der_flags(7), der_flags(8), der_flags(9),
c    *                der_flags(10), der_flags(11), der_flags(12),
     *                alpha_pack,
