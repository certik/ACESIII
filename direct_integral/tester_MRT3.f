...
C  in the file COPYRIGHT.
      subroutine tester_MRT3(a1,a2,b1,b2,c1,c2,d1,d2,
...
c----------------------------------------------------------------------------
               ...
               if (atom(n) .eq. atom(s)) then
                  ...
                  if (der_test1(12) .ne. 0) der_test1(6)  =der_test1(12)
               endif
...
c --------------------------------------------------------------------------
c   Calculate the unperturbed second-derivative. 
c --------------------------------------------------------------------------
...
c --------------------------------------------------------------------------
c   Calculate the perturbed second-derivative. 
c --------------------------------------------------------------------------
...
c    *                                     kcomponent
c              write(6,*) '       FLAGS:', (der_test1(a),a=1,12)
...
c              go to 987 
     ...
     *            0.000001d0) then 
               ...
               write(6,*) ' MISMATCH IN THIRD DERIVATIVE' 
               write(6,*) 'SATOM :', atom(m),atom(n),atom(r),atom(s)
               write(6,*) ' ATOM :', iatom,jatom,katom 
               write(6,*) ' COMP :', icomponent, jcomponent,kcomponent
               write(6,*) '       FLAGS:', (der_test1(a),a=1,12)
